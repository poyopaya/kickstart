...
var App, testBuffer, testDebouncer, testDef, testDropdownButtons, testGrowl, testModal, testNavbar, testStatus, testTabs;
...
},{"../tests/buffer":"/Users/adamkochanowicz/sites/kickstart/lib/tests/buffer.coffee","../tests/debouncer":"/Users/adamkochanowicz/sites/kickstart/lib/tests/debouncer.coffee","../tests/default":"/Users/adamkochanowicz/sites/kickstart/lib/tests/default.coffee","../tests/dropdown-buttons":"/Users/adamkochanowicz/sites/kickstart/lib/tests/dropdown-buttons.coffee","../tests/growl":"/Users/adamkochanowicz/sites/kickstart/lib/tests/growl.coffee","../tests/modal":"/Users/adamkochanowicz/sites/kickstart/lib/tests/modal.coffee","../tests/navbar":"/Users/adamkochanowicz/sites/kickstart/lib/tests/navbar.coffee","../tests/status":"/Users/adamkochanowicz/sites/kickstart/lib/tests/status.coffee","../tests/tabs":"/Users/adamkochanowicz/sites/kickstart/lib/tests/tabs.coffee","./app":"/Users/adamkochanowicz/sites/kickstart/lib/coffee/app.coffee"}],"/Users/adamkochanowicz/sites/kickstart/lib/coffee/app.coffee":[function(require,module,exports){
...
describe('k$.dropdown', function() {
  it('should not apply to elements without uls', function() {
    return expect(k$.$$('#ddbutton1.menu-item').length).to.equal(0);
  });
  it('should apply to button elements', function() {
    return assert(k$.$('#ddbutton2').classList.contains('menu-item'), '.menu-item found');
  });
  ...
  return describe('button with dropdown', function() {
    it('should hav a .menu-item class for parent li', function() {
      return expect(k$.$('#ddbutton3 #dropdownParent').className).to.equal('menu-item');
    });
    it('should show submenu when clicked', function() {
...
describe('k$.modal()', function() {
  ...
  it('should close all modals on body click', function() {
    var $modal, $modal2;
    $modal = showModal();
  ...
  return it('should close modal on "x" click', function() {
    var $modal;
    $modal = showModal();
...
},{"chai":"/Users/adamkochanowicz/sites/kickstart/node_modules/chai/index.js"}],"/Users/adamkochanowicz/sites/kickstart/lib/tests/tabs.coffee":[function(require,module,exports){
var assert, expect;
...
describe('Tabs', function() {
  it('should instantiate', function() {
    return k$.tabs('#test-tabs');
  });
  it('should read for user set "open" class and set view accordingly.', function() {
    return expect(k$.$('#panel-one').classList.contains('open')).to.equal(true);
  });
  it('should add an open class to a tab when clicked upon', function() {
    k$.testClick(k$.$('#test-tabs #tab-three'));
    expect(k$.$('#test-tabs #tab-holder-one').classList.contains('open')).to.equal(false);
    return expect(k$.$('#test-tabs #tab-holder-three').classList.contains('open')).to.equal(true);
  });
  return it('should set only the appropriate pane to be uniquely visible', function() {
    expect(k$.$('#panel-one').classList.contains('open')).to.equal(false);
    expect(k$.$('#panel-two').classList.contains('open')).to.equal(false);
    return expect(k$.$('#panel-three').classList.contains('open')).to.equal(true);
  });
});
