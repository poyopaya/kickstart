...
describe('Tabs', function() {
  ...
  it('should read for user set "open" class and set view accordingly.', function() {
    return expect(k$.$('#panel-one').classList.contains('open')).to.be(true);
  });
  return it('should add an open class to a tab when clicked upon', function() {
    k$.testClick(k$.$('#test-tabs #tab-three'));
    expect(k$.$('#test-tabs #tab-holder-one').classList.contains('open')).to.be(false);
    return expect(k$.$('#test-tabs #tab-holder-three').classList.contains('open')).to.be(true);
  });
});
