...
dropdown = function() {
  ...
  $buttons = k$.$$('button');
  $buttons.concat(k$.$$('[role="button"]'));
  _results = [];
  for (_i = 0, _len = $buttons.length; _i < _len; _i++) {
    $button = $buttons[_i];
    if ($button.querySelector('ul').length) {
