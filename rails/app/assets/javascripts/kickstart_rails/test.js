...
describe('k$.nav()', function() {
  ...
  it('should create a responsive button', function() {
    return expect(k$.$$('#test-nav .navbar-button').length).to.be(true);
  });
