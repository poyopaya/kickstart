...
var App, testBuffer, testDebouncer, testDef, testDropdownButtons, testGrowl, testModal, testNavigation, testStatus;
...
},{"../tests/buffer":"/Users/adamkochanowicz/Sites/kickstart/lib/tests/buffer.coffee","../tests/debouncer":"/Users/adamkochanowicz/Sites/kickstart/lib/tests/debouncer.coffee","../tests/default":"/Users/adamkochanowicz/Sites/kickstart/lib/tests/default.coffee","../tests/dropdown-buttons":"/Users/adamkochanowicz/Sites/kickstart/lib/tests/dropdown-buttons.coffee","../tests/growl":"/Users/adamkochanowicz/Sites/kickstart/lib/tests/growl.coffee","../tests/modal":"/Users/adamkochanowicz/Sites/kickstart/lib/tests/modal.coffee","../tests/navigation":"/Users/adamkochanowicz/Sites/kickstart/lib/tests/navigation.coffee","../tests/status":"/Users/adamkochanowicz/Sites/kickstart/lib/tests/status.coffee","./app":"/Users/adamkochanowicz/Sites/kickstart/lib/coffee/app.coffee"}],"/Users/adamkochanowicz/Sites/kickstart/lib/coffee/app.coffee":[function(require,module,exports){
...
describe("Buffer", function(done) {
  it("Should not prematurely fire functions", function() {
  ...
  it("Should execute all functions 2s between each other (1/3)", function(done) {
    this.timeout(2100);
    return setTimeout(function() {
      if (xArray[0] === 1 && xArray[1] === void 0 && xArray[2] === void 0) {
        return done();
      } else {
  ...
  it("Should execute all functions 2s between each other (2/3)", function(done) {
    this.timeout(2100);
    return setTimeout(function() {
  ...
  return it("Should execute all functions 2s between each other (3/3)", function(done) {
    this.timeout(2100);
    return setTimeout(function() {
...
},{"chai":"/Users/adamkochanowicz/Sites/kickstart/node_modules/chai/index.js"}],"/Users/adamkochanowicz/Sites/kickstart/lib/tests/navigation.coffee":[function(require,module,exports){
var assert, expect;
...
describe('k$.nav()', function() {
  it('should return a DOM element', function() {
    return expect(k$.nav('#test-nav')).to.be.a('object');
  });
...
describe('Status', function() {
  it('should create a status bar and status element.', function() {
    ...
    return expect(k$.$$('#status-bar').length).to.be.above(0);
  });
  it('should apply a custom class to status element.', function() {
    ...
    return expect(k$.$$('#status-bar #status-bar_status[data-type="error"]').length).to.be.above(0);
  });
  it('should disappear via debouncer.', function(done) {
    ...
    return setTimeout(function() {
      if (k$.$$('#status-bar').length === 0) {
        ...
        return console.error("Found " + (k$.$$('#status-bar').length));
      }
    }, 2200);
  });
